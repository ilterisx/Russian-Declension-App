...
const collectiveExamples = {
  ...
  devyatero: {
    nominative: "Девятеро детей играют во дворе.",
    genitive: "У девятерых детей есть игрушки.",
    dative: "Я дал конфеты девятерым детям.",
    accusative: {
      animate: "Я вижу девятерых детей.",
      inanimate: "Я вижу девятеро окон.",
    },
    instrumental: "Я играю с девятерыми детьми.",
    prepositional: "Я думаю о девятерых детях.",
  },
  desyatero: {
