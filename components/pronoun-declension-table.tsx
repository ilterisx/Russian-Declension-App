...
const possessivePronounExamples = {
  my: {
    singular: {
      masculine: {
        nominative: "Мой дом большой.",
        genitive: "Это окно моего дома.",
        dative: "Я иду к моему дому.",
        accusative: {
          animate: "Я вижу моего друга.",
          inanimate: "Я вижу мой дом.",
        },
        instrumental: "Я доволен моим домом.",
        prepositional: "Я говорю о моём доме.",
      },
      feminine: {
        nominative: "Моя книга интересная.",
        genitive: "Это страница моей книги.",
        dative: "Я возвращаюсь к моей книге.",
        accusative: "Я читаю мою книгу.",
        instrumental: "Я доволен моей книгой.",
        prepositional: "Я говорю о моей книге.",
      },
      neuter: {
        nominative: "Моё окно чистое.",
        genitive: "Это рама моего окна.",
        dative: "Я подхожу к моему окну.",
        accusative: "Я вижу моё окно.",
        instrumental: "Я доволен моим окном.",
        prepositional: "Я говорю о моём окне.",
      },
    },
    plural: {
      nominative: "Мои друзья приехали.",
      genitive: "Это вещи моих друзей.",
      dative: "Я иду к моим друзьям.",
      accusative: {
        animate: "Я вижу моих друзей.",
        inanimate: "Я вижу мои книги.",
      },
      instrumental: "Я доволен моими друзьями.",
      prepositional: "Я говорю о моих друзьях.",
    },
  },
}
...
const demonstrativePronounExamples = {
  this: {
    singular: {
      masculine: {
        nominative: "Этот дом новый.",
        genitive: "Окно этого дома большое.",
        dative: "Я подхожу к этому дому.",
        accusative: {
          animate: "Я вижу этого человека.",
          inanimate: "Я вижу этот дом.",
        },
        instrumental: "Я доволен этим домом.",
        prepositional: "Я говорю об этом доме.",
      },
      feminine: {
        nominative: "Эта книга интересная.",
        genitive: "Страница этой книги порвана.",
        dative: "Я возвращаюсь к этой книге.",
        accusative: "Я читаю эту книгу.",
        instrumental: "Я доволен этой книгой.",
        prepositional: "Я говорю об этой книге.",
      },
      neuter: {
        nominative: "Это окно чистое.",
        genitive: "Рама этого окна деревянная.",
        dative: "Я подхожу к этому окну.",
        accusative: "Я вижу это окно.",
        instrumental: "Я доволен этим окном.",
        prepositional: "Я говорю об этом окне.",
      },
    },
    plural: {
      nominative: "Эти дома новые.",
      genitive: "Окна этих домов большие.",
      dative: "Я подхожу к этим домам.",
      accusative: {
        animate: "Я вижу этих людей.",
        inanimate: "Я вижу эти дома.",
      },
      instrumental: "Я доволен этими домами.",
      prepositional: "Я говорю об этих домах.",
    },
  },
}
...
const interrogativePronounExamples = {
  who: {
    nominative: "Кто пришёл?",
    genitive: "У кого есть ручка?",
    dative: "К кому ты идёшь?",
    accusative: "Кого ты видишь?",
    instrumental: "С кем ты говоришь?",
    prepositional: "О ком ты думаешь?",
  },
  what: {
    nominative: "Что случилось?",
    genitive: "Чего ты хочешь?",
    dative: "К чему ты стремишься?",
    accusative: "Что ты видишь?",
    instrumental: "Чем ты занимаешься?",
    prepositional: "О чём ты думаешь?",
  },
}
...
const negativePronounExamples = {
  nobody: {
    ...
    genitive: "Ни у кого нет ручки.",
    dative: "Ни к кому не подходи.",
    accusative: "Я никого не вижу.",
    instrumental: "Ни с кем не разговаривай.",
    prepositional: "Ни о ком не думай.",
  },
  nothing: {
    nominative: "Ничто меня не беспокоит.",
    genitive: "Ни от чего не отказывайся.",
    dative: "Ни к чему не прикасайся.",
    accusative: "Я ничего не вижу.",
    instrumental: "Ничем не интересуюсь.",
    prepositional: "Ни о чём не беспокойся.",
  },
}
...
const reflexivePronounExamples = {
  oneself: {
    nominative: "-",
    genitive: "Он боится себя.",
    dative: "Он не доверяет себе.",
    accusative: "Он видит себя в зеркале.",
    instrumental: "Он доволен собой.",
    prepositional: "Он думает о себе.",
  },
  each_other: {
    nominative: "-",
    genitive: "Они боятся друг друга.",
    dative: "Они не доверяют друг другу.",
    accusative: "Они видят друг друга.",
    instrumental: "Они довольны друг другом.",
    prepositional: "Они думают друг о друге.",
  },
}
